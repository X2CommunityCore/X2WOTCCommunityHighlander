...
static function X2Effect_Persistent CreateUltrasonicLureTargetStatusEffect()
{
	...
	UltrasonicLureTargetEffect.BuildPersistentEffect(default.ULTRASONICLURE_TURNS, true, false,,eGameRule_PlayerTurnBegin); //Issue #1286 - Keep effect when source dies & add tick on start of player turn
	UltrasonicLureTargetEffect.SetDisplayInfo(ePerkBuff_Penalty, default.UltrasonicLureFriendlyName, default.UltrasonicLureFriendlyDesc, "img:///UILibrary_PerkIcons.UIPerk_mark" );
