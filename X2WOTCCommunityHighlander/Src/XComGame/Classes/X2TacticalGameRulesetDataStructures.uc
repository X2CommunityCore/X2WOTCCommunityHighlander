...
enum EInventorySlot
{
	...
	// Added comments to indicate which modders requested the slots and the mods they 
	// mainly refer to - Users adding new custom enums should record who & why here.
