...
function EventListenerReturn OnAbilityActivated(Object EventData, Object EventSource, XComGameState GameState, Name Event, Object CallbackData)
{
	...
	// Start Issue #892
	TriggerOverrideLostSpawnIncreasePerUse(ActivatedAbilityState, GameState, LostSpawnModifier);
	// End Issue #892
...
// Start Issue #892
/// HL-Docs: feature:OverrideLostSpawnIncreasePerUse; issue:892; tags:tactical
...
/// The `XComGameState_Unit::OnAbilityActivated` triggers a `OverrideLostSpawnIncreasePerUse` event, 
/// allowing mods to override the amount of Lost-attracting noise generated by abilities.
/// ```unrealscript
/// EventID: OverrideLostSpawnIncreasePerUse
/// /// EventData: XComLWTuple {
/// 	Data: [
...
/// }
/// ```
private function TriggerOverrideLostSpawnIncreasePerUse(XComGameState_Ability ActivatedAbilityState, XComGameState GameState, out int LostSpawnModifier)
{
	local XComLWTuple OverrideTuple;

	OverrideTuple = new class'XComLWTuple';
	OverrideTuple.Id = 'OverrideLostSpawnIncreasePerUse';
