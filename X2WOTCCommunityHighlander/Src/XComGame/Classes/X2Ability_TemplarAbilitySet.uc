...
static function X2AbilityTemplate Pillar()
{
	...
	// Start Issue #1388 - Add an event listener to update cover after the ability has been fully visualized
	EventListener = new class'X2AbilityTrigger_EventListener';
	...
	Template.AbilityTriggers.AddItem(EventListener);
	// Ability visualises better without the step-out animation
