...
{
	// Start Issue #533
	// The below code that was commented out is no longer needed because the stat calculation is done in the new function
	// CalcAndDisplaySoldierStats() in the UISoldierHeader class.
	...
	SoldierHeader.CalcAndDisplaySoldierStats(Unit);
	// End issue #533
}
