...
# append extra_globals.uci to xcomglobals.uci
...
# one level up
Compress-Archive -Path "$stagingPath" -CompressionLevel Optimal -DestinationPath "$srcDirectory/$modNameCanonical.zip"
