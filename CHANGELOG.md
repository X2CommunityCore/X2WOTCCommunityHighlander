...
- Triggers the event `OnBestGearLoadoutApplied` to allow mods to override Unit's loadout after it has been changed by `XComGameState_Unit::ApplyBestGearLoadout()` (#676)
